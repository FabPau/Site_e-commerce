...
<html>
 ...
 <body>
  ...
  <h1>Modifier ou retirer un produit</h1>

  <!-- Rechercher un produit via formulaire -->
  <p>Rechercher un produit par : <p>
  <form name="retirerP" method="post" action="modifProduit.php">
    <table>
      <tr>
  ...
  <?php
    ...
    if(isset($_POST['marque']) && isset($_POST['nom_c'])){
      ...
      //pour chaque ligne de chaussure
      foreach($res1 as $chaus){
        ...
        echo "<td>
                  <form name=\"modifier\" method=\"post\" action=\"verifModif.php\">
                    <input type=\"hidden\" value=\"".$chaus["id_c"]."\" name =\"id\">
                    <input type=\"submit\" value=\"Modifier ce produit\"> 
                  </form>
                  <form name=\"retirer\" method=\"post\" action=\"verifRetirer.php\">
                    <input type=\"hidden\" value=\"".$chaus["id_c"]."\" name =\"id\">
